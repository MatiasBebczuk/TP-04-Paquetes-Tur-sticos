class ORTworld{    public static List < string > ListaDestinos {get; private set;}  = new List<string>{"BUENOS AIRES, ARGENTINA", "PORTO, BRASIL", "PARIS, FRANCIA", "MADRID, ESPAÑA", "NEW YORK, USA", "MOSCÚ, RUSIA", "CASABLANCA, MARRUECOS", "MONTEVIDEO, URUGUAY", "ROMA, ITALIA", "ATENAS, GRECIA"};
